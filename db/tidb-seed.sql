-- ============================================================
-- TiDB TEMPLATE SEED (core compatibility file)
-- Run this file against the ADMIN DB (dev_admin / prd_admin)
-- 推奨:
--   core     -> db/core/tidb-seed.sql
--   optional -> db/optional/tidb-seed.sql
-- ============================================================
...
-- ============================================================
-- Admin user
-- Use scripts/generate-admin-user-sql.mjs to generate the INSERT statement.
-- Example:
