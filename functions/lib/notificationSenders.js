...
exports.getNotificationSender = getNotificationSender;
...
class EmailNotificationSender {
    ...
    async send(to, kycLink, sessionName, emailSettings) {
        var _a;
        const expiresInDays = (_a = emailSettings === null || emailSettings === void 0 ? void 0 : emailSettings.expiresInDays) !== null && _a !== void 0 ? _a : 7;
        const lang = (emailSettings === null || emailSettings === void 0 ? void 0 : emailSettings.language) || 'ja';
        // 件名の組み立て
        const subject = (emailSettings === null || emailSettings === void 0 ? void 0 : emailSettings.emailSubject)
        ...
        const textBody = (emailSettings === null || emailSettings === void 0 ? void 0 : emailSettings.emailBody)
        ...
        const htmlBody = (emailSettings === null || emailSettings === void 0 ? void 0 : emailSettings.emailBody)
            ? emailSettings.emailBody
                .replace(/\{sessionName\}/g, sessionName)
 ...
 */
function getNotificationSender(type) {
    switch (type) {
        case 'email':
...
//# sourceMappingURL=notificationSenders.js.map