...
export const syncTransactionsDev = regionalFunctions.https.onRequest((req, res) => handleSyncTransactions(req, res, 'dev'));
export const syncTransactionsPrd = regionalFunctions.https.onRequest((req, res) => handleSyncTransactions(req, res, 'prd'));
