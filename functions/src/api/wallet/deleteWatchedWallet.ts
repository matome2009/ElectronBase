...
export const deleteWatchedWalletDev = regionalFunctions.https.onRequest((req, res) => handleDeleteWatchedWallet(req, res, 'dev'));
export const deleteWatchedWalletPrd = regionalFunctions.https.onRequest((req, res) => handleDeleteWatchedWallet(req, res, 'prd'));
