...
export const getLabelsDev = regionalFunctions.https.onRequest((req, res) => handleGetLabels(req, res, 'dev'));
export const getLabelsPrd = regionalFunctions.https.onRequest((req, res) => handleGetLabels(req, res, 'prd'));
