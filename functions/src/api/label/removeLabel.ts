...
export const removeLabelDev = regionalFunctions.https.onRequest((req, res) => handleRemoveLabel(req, res, 'dev'));
export const removeLabelPrd = regionalFunctions.https.onRequest((req, res) => handleRemoveLabel(req, res, 'prd'));
